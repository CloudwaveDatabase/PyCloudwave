[![Documentation Status](https://readthedocs.org/projects/pycloudwave/badge/?version=latest)](https://pycloudwave.readthedocs.io/)
...
Documentation is available online: <https://pycloudwave.readthedocs.io/>

For support, please refer to the
[StackOverflow](https://stackoverflow.com/questions/tagged/pycloudwave).
...
``` python
import pycloudwave.cursors

# Connect to the database
connection = pycloudwave.connect(host='localhost',
                             user='user',
                             password='passwd',
                             database='db',
                             cursorclass=pycloudwave.cursors.DictCursor)
...
- PyMySQL mailing list:
  <https://groups.google.com/forum/#!forum/pycloudwave-users>
