...
# cloudwave_native_password
# https://dev.cloudwave.com/doc/internals/en/secure-password-authentication.html#packet-Authentication::Native41



def sha1_secret_bytes(password):
    """Scramble used for cloudwave_native_password"""
    sha = hashlib.sha1(password).digest()
    en_str = base64.b64encode(sha)
    return en_str
...
def _xor_password(password, salt):
    ...
    # See https://github.com/cloudwave/cloudwave-server/blob/7d10c82196c8e45554f27c00681474a9fb86d137/sql/auth/sha2_password.cc#L939-L945
