...
class CloudwaveError(Exception):
    """Exception related to operation with Cloudwave."""


class Warning(Warning, CloudwaveError):
    """Exception raised for important warnings like data truncations
    while inserting, etc."""


class Error(CloudwaveError):
...
def raise_cloudwave_exception(data):
