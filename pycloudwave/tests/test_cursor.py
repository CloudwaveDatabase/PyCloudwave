...
class CursorTest(base.PyCloudwaveTestCase):
    def setUp(self):
        ...
        cursor.close()
        self.test_connection = pycloudwave.connect(**self.databases[0])
        self.addCleanup(self.test_connection.close)

    def test_cleanup_rows_unbuffered(self):
        conn = self.test_connection
        cursor = conn.cursor(pycloudwave.cursors.SSCursor)
    ...
    def test_cleanup_rows_buffered(self):
        conn = self.test_connection
        cursor = conn.cursor(pycloudwave.cursors.Cursor)
    ...
    def test_executemany(self):
        ...
        m = pycloudwave.cursors.RE_INSERT_VALUES.match(
        ...
        # https://github.com/PyCloudwave/PyCloudwave/pull/597
        m = pycloudwave.cursors.RE_INSERT_VALUES.match(
        ...
        try:
            ...
            self.assertIsNotNone(pycloudwave.cursors.RE_INSERT_VALUES.match(q))
