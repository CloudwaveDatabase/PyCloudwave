...
class PyCloudwaveTestCase(unittest.TestCase):
    ...
    def cloudwave_server_is(self, conn, version_tuple):
        ...
        e.g.::
            ...
            if self.cloudwave_server_is(conn, (5, 6, 4)):
                # do something for Cloudwave 4.0.1 and above
        """
    ...
    def connections(self):
        if self._connections is None:
            ...
            for params in self.databases:
                self._connections.append(pycloudwave.connect(**params))
