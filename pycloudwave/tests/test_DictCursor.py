...
class TestDictCursor(base.PyCloudwaveTestCase):
    ...
    def test_DictCursor(self):
        ...
        # all assert test compare to the structure as would come out from CloudwaveDB
        conn = self.conn
        c = conn.cursor(self.cursor_type)
...
class TestSSDictCursor(TestDictCursor):
    cursor_type = pycloudwave.cursors.SSDictCursor
