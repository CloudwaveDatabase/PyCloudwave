...
class test_CloudwaveDB(capabilities.DatabaseTest):
    db_module = pycloudwave
    connect_args = ()
    connect_kwargs = base.PyCloudwaveTestCase.databases[0].copy()
    ...
    def test_bug_2671682(self):
        from pycloudwave.constants import ER
