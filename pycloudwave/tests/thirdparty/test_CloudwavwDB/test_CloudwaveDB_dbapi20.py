...
class test_CloudwaveDB(dbapi20.DatabaseAPI20Test):
    driver = pycloudwave
    connect_args = ()
    connect_kw_args = base.PyCloudwaveTestCase.databases[0].copy()
    ...
    result set. Cloudwave always returns a result set; it's just that
    ...
    def test_callproc(self):
        pass  # performed in test_Cloudwave_capabilities
        ...
        try:
            ...
            try:
                ...
                if s:
                    ...
                    # warn("Incompatibility: Cloudwave returns an empty result set for the CALL itself",
                    #     Warning)
